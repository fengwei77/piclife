...
function RunGLNL() {
    ...
    var DDDD = DDDD + " " + (CnDateofDateStr(today)); //顯示農曆
...
function CnEra(YYYY) {
    ...
    //var Dizhi=new Array("子(鼠)","醜(牛)","寅(虎)","卯(兔)","辰(龍)","巳(蛇)",
    //"午(馬)","未(羊)","申(猴)","酉(雞)","戌(狗)","亥(豬)");
    var Dizhi = new Array("子", "醜", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥");
...
function SolarTerm(DateGL) {
    ...
    if (DateGL.getDate() == BeginTime.getDate()) {
        ...
        JQ += "　 後日 <font color='#598F03'><b>" + SolarTermStr[M] + "</b></font>";
    } else {
        JQ = " 二十四節氣";
